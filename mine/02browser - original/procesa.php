...
if ( isset($_POST['indice']) ) 
    ...
    //si la búsqueda NO arroja resultados, no se escribe nada y tampoco se muestra la tabla temporal
    if ($num_results != 0) {
...
<div id='wcambiaeancode' name='wcambiaeancode' class="wchanger">
    Usted ha solicitado cambiar el código EAN del producto.
    <br />   
    <br />  
    Código EAN actual:
    <br />   
...
<div id='wcambiamarcaprod' name='wcambiamarcaprod' class="wchanger">
    ...
    <form action='<?php echo $_SERVER['PHP_SELF'] ?>' method='post' target='presen'>
        ...
        <input type='hidden' name="ean" value='<?php echo $ridproduct ?>' />
        <br /><br />  
        <input type='reset' name='cancelar' value="Cancelar" onclick="cerrar_changewindow('wcambiamarcaprod');" />
...
<div id='wcambiadescripcion' name='wcambiadescripcion' class="wchanger">
    ...
    <form action='".$_SERVER['PHP_SELF']."' method='post' target='presen'>
