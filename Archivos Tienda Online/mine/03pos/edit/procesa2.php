...
<script>
    function envia_formedit(code) 
        {
            document.formedit.eancoded.value = code;
...
<div class="cuadro">
    ...
    // Esta parte se procesa cuando se presiona el botÃ³n TERMINAR
    ...
    if ( isset($_POST['endtransaction']) ) 
        ...
        ?>      
        <script language="javascript">
            parent.presen.document.location.href="procesa.php";
            top.naver.document.location.href="naver.php";
            top.naver.document.buscafield.cadena.focus();
        </script>  
        <?php
...
// Esta parte se procesa cuando se presiona los botones de borrar ï¿½tem
...
// Esta parte ejecuta la bÃºsqueda en la tabla PRODUCTOS +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 if ( isset($_POST['cadena']) ) {
    ...
    $num_results = $result->num_rows; echo $num_results;
    
    if ($tipobusqueda == "nombreprod") 
    {
        echo "<form action='procesa.php' method='post' name='formedit'>";    
        echo "<table width='940' border='2'>";
        echo "<tr><td class='titles' align='center'>No</td><td class='titles' align='center'>Nombre</td><td class='titles' align='center'>Marca</td><td class='titles' align='center'>Presentación</td><td class='titles' align='center'>Precio</td></tr>";  //encabezados
        for ($i=0; $i<$num_results; $i++) 
            ...
            echo "<td>".stripslashes($row['presentitem'])."</td>";
            echo "<td align='right'> $".stripslashes($row['precioactual'])."</td>";
            echo "<td align='center'>";
            echo "<input type='button' name='editar' value='Editar' onClick='javascript:envia_formedit(".$reancode.")' />";
        ...
        echo "</table>";
        echo "<input type='hidden' name='eancoded' />";
    ...
    //AquÃ­ se escribe el resultado de la consulta en la tabla TEMPORAL,
    //pero si la bï¿½squeda NO arroja resultados, no se inserta nada en TEMPORAL
    ...
    if ($tipobusqueda == "eancode" && $num_results != 0 ) {  
        ...
        //aquï¿½ se insertan los datos, excepto si se trata de una bï¿½squeda por nombre del producto
